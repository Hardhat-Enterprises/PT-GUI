...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        aboutframe = tk.Label(self, text="    References", bg='#64C1DA', anchor="w", font=framefont)
        ...
        button_references = tk.Button(self, text="References", bg="#9A9A9A", borderwidth=6, font=controller.btn_font2 , command=lambda: controller.show_frame("PageFour"))
