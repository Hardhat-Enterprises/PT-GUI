...
"""
Similar to return string but will print anything from stdout to the multiline
"""
...
layout =   [[sg.Text('Hash Analyzer Reroute Stdout')],
...
window = sg.Window('Hash Analyzer Reroute Stdout', layout)
