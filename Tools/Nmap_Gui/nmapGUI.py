...
def MAKE_nmapGUI():
    ...
    layout = [
    [sg.Text('Enter The NMAP Scan Information Below', justification='center', size =(60, 1),key='-bold-', font='Celebri 26', background_color= '#3B5262')],
    [sg.Text('Enter sudo password: ', size =(17, 1), font='Celebri 18'), sg.InputText(font='Celebri 18', key='-PASS-', size=(22,1), password_char='*')],
    [sg.Text('Enter IP to scan:', size =(17, 1), font='Celebri 18'), sg.InputText(font='Celebri 18', key='-IP1-', size=(22,1))],
        [sg.Text('Port (optional):', size =(17, 1), font='Celebri 18'), sg.InputText(font='Celebri 18', key='-PORT1-',
    size=(22,1)), sg.CBox('Top 20 ports', font='Celebri 18', key='-PORT2-')],
    [sg.Text('Scan Type:', size =(17, 1), font='Celebri 18'), sg.Combo(('All', 'Operating System', 'Firewall Status', 'Services', 'Stealth', 'Device discovery', 'Vulscan(CVE finder)'), size=(21,1), default_value='All', font='Celebri 18',
    key='-SCAN1-')],
    [sg.Text('Speed:', size =(17, 1), font='Celebri 18'), sg.Combo(('T1', 'T2', 'T3', 'T4', 'T5'), size=(21,1), default_value='T3', font='Celebri 18', key='-SCAN2-'), sg.CBox('Save results', font='Celebri 18', key='-LOG1-')],
    #[sg.CBox('Vulscan (service scan type only): returns CVEs for detected services', key='-VULSCAN-')],
    [sg.Button('Scan', enable_events=True, font='Celebri 18', key="-SUBMIT-"), sg.Button('Close', font='Celebri 18', button_color=('black','#c4c4c4'))],
        [sg.MLine(default_text='Results: ', disabled=True, write_only=True, autoscroll=True, size=(120, 16), font='Celebri 16', key='multi1')]]
