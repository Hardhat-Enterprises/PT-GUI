...
def display_nav_bar(frame, controller):
    ...
    button_home = tk.Button(frame, text="Home", bg='#6f8396', fg='white', borderwidth=border,
     relief=style, font=controller.btn_font2, command=lambda: controller.show_frame("StartPage"))
    button_vectors = tk.Button(frame, text="Attack Vectors", bg='#4D6C84', fg='white',
    borderwidth=border, relief=style, font=controller.btn_font2,
        command=lambda: controller.show_frame("VectorsPage"))
    button_about = tk.Button(frame, text="About", bg='#3A4C5E', fg='white', borderwidth=border,
     relief=style, font=controller.btn_font2, command=lambda: controller.show_frame("AboutPage"))
    button_tools = tk.Button(frame, text="Tools", bg='#3B5262', fg='white', borderwidth=border,
     relief=style, font=controller.btn_font2, command=lambda: controller.show_frame("ToolsPage"))
    button_walkthroughs = tk.Button(frame, text="Walkthroughs", bg='#375973', fg='white',
     borderwidth=border, relief=style, font=controller.btn_font2,
     command=lambda: controller.show_frame("WalkthroughClass"))
    button_references = tk.Button(frame, text="References", bg='#2E414F', fg='white',
     borderwidth=border, relief=style, font=controller.btn_font2,
