...
class MimtDnsSpoof(tk.Frame):
    def __init__(self, parent, controller):
        ...
        aboutframe = tk.Label(self, text="    Packet Sniffing Tool", bg='#3B5262', fg='white', anchor="c",
                              font=abtframefont)
        ...
        label = Label(self, text="Victim IP:", font=('Calibri', 13), bg='#4D6C84', fg='white', anchor='c').place(
            rely=0.28, relx=0.16, relheight=0.04, relwidth=0.2)
        label = Label(self, text="Gatewat IP:", font=('Calibri', 13), bg='#4D6C84', fg='white', anchor='c').place(
            rely=0.33, relx=0.16, relheight=0.04, relwidth=0.2)
        label = Label(self, text="Interface:", font=('Calibri', 13), bg='#4D6C84', fg='white', anchor='c').place(
            rely=0.38, relx=0.16, relheight=0.04, relwidth=0.2)
        label = Label(self, text="Attacker's IP:", font=('Calibri', 13), bg='#4D6C84', fg='white', anchor='c').place(
            rely=0.43, relx=0.16, relheight=0.04, relwidth=0.2)
        ...
        Button(self, text="Start", font=('Calibri', 14), bg='#4D6C84', fg='white', anchor='c',
               command=self.mymimtdns).place(rely=0.38, relx=0.7, relheight=0.08, relwidth=0.08)
