...
class BannerGrab(tk.Frame):
	def __init__(self, parent, controller):
		...
		label = Label(self, text =" Enter Target IP Address:",font=('Calibri', 14), bg='#4D6C84', fg='white', anchor='c').place(rely=0.38, relx=0.16, relheight=0.08, relwidth=0.22)
		label = Label(self, text =" Enter Port Number:",font=('Calibri', 14), bg='#4D6C84', fg='white', anchor='c').place(rely=0.48, relx=0.16, relheight=0.08, relwidth=0.22)
		...
		# Start button
		Button(self,text="Start",font=('Calibri', 14), bg='#4D6C84', fg='white', anchor='c',command=self.mainprog).place(rely=0.43, relx=0.7, relheight=0.08, relwidth=0.08)
