...
class ZipBF(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        aboutframe = tk.Label(self, text="    ZIP Password Brute Forcer", bg='#3B5262', fg='white', anchor="w",
                              font=abtframefont)
        ...
        labelFilepath = Label(self, text="Filepath: ",
                              font=('Calibri', 9), bg='white', anchor='w').place(rely=0.27, relx=0.35, relheight=0.06,
                                                                                 relwidth=0.45)
    ...
    def get_file(self):
        ...
        labelFilepath = Label(self, text="Filepath: " + zip_file,
                              font=('Calibri', 9), anchor='w').place(rely=0.27, relx=0.35, relheight=0.06,
                                                                     relwidth=0.45)
