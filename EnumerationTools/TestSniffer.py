...
class TestSniff(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Set input box Entry
        label = Label(self, text=" Enter the interface to sniff packets:", font=('Calibri', 13), bg='#4D6C84',
                      fg='white', anchor='c').place(rely=0.38, relx=0.16, relheight=0.08, relwidth=0.22)
        ...
        Button(self, text="Start", font=('Calibri', 14), bg='#4D6C84', fg='white', anchor='c',
               command=self.mysniffer).place(rely=0.48, relx=0.46, relheight=0.08, relwidth=0.08)
        Button(self, text="Stop", font=('Calibri', 14), bg='#4D6C84', fg='white', anchor='c', command=self.stop).place(
            rely=0.58, relx=0.46, relheight=0.08, relwidth=0.08)
