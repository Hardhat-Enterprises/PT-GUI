...
#second link with element text matching regaular expression
response1 = br.follow_link(text_regex=r"randon text", nr=1)
print(br.title())
...
#controlling the browser's policy by using the methods of mechanize browser's bse class, mechanize.UserAgent
br = mechanize.Browser()
...
#mechanize exports the complete interface of userlibrary2
import mechanize
