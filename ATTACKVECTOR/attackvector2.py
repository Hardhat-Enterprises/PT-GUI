...
class AttackVectorTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def change_to_Step2():
            ...
            step2frame = tk.Message(main_frame, text=text, fg='black', bg='white',  font=('Calibri', 20), anchor= 'nw', aspect=350)
        ...
        title_label = tk.Label(self, text="Directory Triversal & IDOR", bg='#4D6C84', fg='white', anchor="c", font=framefont)
        ...
        sidescreenframe = tk.Label(main_frame, text="\n          Steps\n\n", bg='#E7E7E7',  font=('Calibri', 20, 'bold'), anchor= 'nw')
