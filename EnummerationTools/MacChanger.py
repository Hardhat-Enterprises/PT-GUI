...
class MacChange(tk.Frame):
	def __init__(self, parent, controller):
		...
		aboutframe = tk.Label(self, text="    MAC Changer Tool", bg='#3B5262', fg='white', anchor="c", font=abtframefont)
		...
		label = Label(self,text ="Choose a vendor from the list",font=('Calibri', 13), bg='white', anchor='c').place(rely=0.33, relx=0.359, relheight=0.08)
		
		# Set drop down box 
		label = Label(self,text ="Selet your network Interface",font=('Calibri', 13), bg='white', anchor='c').place(rely=0.43, relx=0.359, relheight=0.08)
		...
		# Start button
		Button(self,text="Change MAC",font=('Calibri', 13),bg='#4D6C84', fg='white', anchor='c', command=self.myMac).place(rely=0.35, relx=0.7, relheight=0.08, relwidth=0.12)
		
		# revert button
		Button(self,text="Original MAC",font=('Calibri', 13),bg='#4D6C84', fg='white', anchor='c', command=self.OriginalMac).place(rely=0.47, relx=0.7, relheight=0.08, relwidth=0.12)
	...
	def OriginalMac(self):
		...
		if current_mac == macchanger_result:
			...
			failresult = Label(self, text="MAC address couldnt be changed\nAccording to standerds MAC should start with and end in even pair", font=('Calibri', 13))
	...
	def myMac(self):
		...
		changemaclabel = Label(self, text="Changeing MAC address for "+ interface + " to: "+ current_mac, font=('Calibri', 13))
