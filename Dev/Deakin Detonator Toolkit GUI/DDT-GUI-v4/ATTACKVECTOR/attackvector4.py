...
class AttackVectorFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def change_to_Step1():
            ...
            XSSButton = tk.Button(step1frame, text="SQL injection Tool", bg="#E7E7E7", fg="black", font=highlightFont, command=load_sqli, relief='flat').place(rely=0.5, relx=0.02, relheight=0.05, relwidth=0.1)
...
#
        ...
        maintainnotice = tk.Label(self,text="ATTACK VECTOR 4 being maintaining", bg ='#6f8396', fg='white', borderwidth=8, relief=RAISED,
