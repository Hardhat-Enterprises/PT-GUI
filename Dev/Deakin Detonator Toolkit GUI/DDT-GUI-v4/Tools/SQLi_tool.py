...
# Set input box 
		label = Label(self,text =" Enter URL",font=('Calibri', 13), anchor='c').place(rely=0.48, relx=0.08, relheight=0.08, relwidth=0.24)
...
# Start button
		Button(self,text="Click to Change Mac",font=('Calibri', 13),anchor='c', command=self.myMac).place(rely=0.44, relx=0.7, relheight=0.08, relwidth=0.12)
